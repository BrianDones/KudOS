...
module TSOS {
    ...
    export class Control {
        ...
        public static hostLog(msg: string, source: string = "?"): void {
            ...
            var str: string = "({Clock:" + clock + ", source:" + source + ", msg:" + msg + " })"  + "\n";

            var str2: string ="Status: " + status + "     " + weekday + ", " +
        ...
        public static enableSingleStep(btn): void {
        ...
        public static disableSingleStep(btn): void {
            document.getElementById("btnSingleStepEnabled").disabled = false;
        ...
        public static takeAStep(btn): void {
